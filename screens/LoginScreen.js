...
//         if (data.employee) {
//           await AsyncStorage.setItem("isManager", JSON.stringify(data.employee.isManager || false));
//           await AsyncStorage.setItem("isHod", JSON.stringify(data.employee.isHod || false));
...
//                 © Business Excellence 2025. All rights reserved to Idea Bank Application
//               </Text>
...
const isVerySmallDevice = height < 650;  // iPhone SE, small Androids
const isSmallDevice = height >= 650 && height < 750;  // iPhone 12/13 Mini
const isMediumDevice = height >= 750 && height < 850;  // iPhone 12/13/14
const isLargeDevice = height >= 850 && height < 950;  // iPhone Pro Max, large Androids
const isTablet = height >= 950;  // iPads, Android tablets

// Helper function to get responsive value
const getResponsiveValue = (verySmall, small, medium, large, tablet) => {
          ...
          <View style={styles.container}>
            ...
            <View style={styles.loginCard}>
              ...
              <View style={styles.copyrightContainer}>
                ...
                <Text style={styles.copyrightText}>
                  © Business Excellence 2025
                </Text>
                <Text style={styles.copyrightSubtext}>
                  All rights reserved to Idea Bank Application
                </Text>
              </View>
            </View>
          </View>
...
const styles = StyleSheet.create({
  ...
  topBackground: { 
    height: height * getResponsiveValue(0.30, 0.32, 0.36, 0.38, 0.40),
    backgroundColor: '#fff', 
    alignItems: 'center', 
    justifyContent: 'center',
    paddingTop: Platform.OS === 'android' ? StatusBar.currentHeight + 10 : 20,
  ...
  topIllustration: { 
    width: '100%',
    height: getResponsiveValue('55%', '60%', '70%', '75%', '80%'),
    maxHeight: getResponsiveValue(180, 200, 230, 260, 300),
  },
  loginCard: { 
    position: 'absolute', 
    top: height * getResponsiveValue(0.24, 0.26, 0.30, 0.32, 0.34),
    alignSelf: 'center', 
    width: width * 0.9,
    maxWidth: 450,
    backgroundColor: '#fff', 
    borderRadius: 24, 
    paddingHorizontal: width * 0.06,
    paddingVertical: getResponsiveValue(18, 20, 25, 28, 32),
    elevation: 8, 
    shadowColor: '#000', 
    shadowOffset: { width: 0, height: 4 }, 
    shadowOpacity: 0.12, 
  ...
  ideaBankLogo: { 
    width: getResponsiveValue('65%', '70%', '75%', '75%', '70%'),
    height: getResponsiveValue(45, 50, 60, 70, 80),
    alignSelf: 'center', 
    marginBottom: getResponsiveValue(6, 8, 10, 12, 14),
    marginTop: getResponsiveValue(3, 5, 10, 12, 15),
  },
  loginTitle: { 
    ...
    textAlign: 'center', 
    color: '#2c5aa0', 
    marginBottom: getResponsiveValue(10, 12, 15, 18, 20),
    letterSpacing: 0.3,
  },
  inputContainer: { 
    flexDirection: 'row', 
    ...
    borderRadius: 12, 
    paddingHorizontal: 16, 
    marginBottom: getResponsiveValue(8, 10, 12, 14, 16),
    borderWidth: 1.5,
    borderColor: '#e9ecef',
    height: getResponsiveValue(46, 48, 52, 54, 58),
  },
  input: { 
    flex: 1, 
    color: '#495057',
    fontSize: getResponsiveValue(13, 14, 15, 16, 17),
    paddingVertical: 0,
  },
  forgotPasswordContainer: {
    alignSelf: 'center', 
    marginTop: getResponsiveValue(6, 8, 8, 10, 12), 
    marginBottom: getResponsiveValue(12, 14, 18, 20, 22),
    paddingVertical: 4,
  },
  forgotText: { 
    fontSize: getResponsiveValue(12, 13, 14, 14, 15),
    color: '#666', 
    fontWeight: '500',
  },
  loginButton: { 
    backgroundColor: '#2c5aa0', 
    paddingVertical: getResponsiveValue(12, 13, 15, 16, 18),
    borderRadius: 12, 
    alignItems: 'center', 
    marginTop: getResponsiveValue(6, 8, 8, 10, 12),
    marginBottom: getResponsiveValue(8, 10, 15, 16, 18),
    elevation: 3,
    shadowColor: '#2c5aa0',
    shadowOffset: { width: 0, height: 3 },
    shadowOpacity: 0.2,
  ...
  loginButtonText: { 
    color: '#fff', 
    fontWeight: 'bold', 
    fontSize: getResponsiveValue(15, 16, 17, 18, 19),
    letterSpacing: 0.5,
  },
  toastWrapper: { 
    position: 'absolute', 
  ...
  copyrightContainer: {
    alignItems: 'center',
    marginTop: getResponsiveValue(8, 10, 14, 16, 18),
    paddingTop: getResponsiveValue(10, 12, 15, 16, 18),
  },
  dividerLine: {
    width: '30%',
    height: 1,
    backgroundColor: '#e0e0e0',
    marginBottom: getResponsiveValue(8, 10, 12, 12, 14),
  },
  copyrightText: {
  ...
  copyrightSubtext: {
    fontSize: getResponsiveValue(9, 10, 11, 12, 13),
    color: '#6c757d',
    textAlign: 'center',
    fontWeight: '400',
    letterSpacing: 0.2,
