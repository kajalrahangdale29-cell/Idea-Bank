...
//   const [employeeId, setEmployeeId] = useState(''); // 👈 to store employee username/id
...
//           console.log("User from storage:", parsed.employee);

//           setEmployeeName(parsed.employee.name);      // Full name
//           setEmployeeId(parsed.employee.username);    // Employee username (ID)
//         }
//       } catch (error) {
