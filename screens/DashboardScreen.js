...
import { DASHBOARD_URL, NOTIFICATION_USER_URL, NOTIFICATION_COUNT_URL, MARK_READ_URL, CLEAR_ALL_URL, REDIRECT_NOTIFICATION_URL, IDEA_DETAIL_URL, PENDING_APPROVALS_URL, BASE_URL } from '../src/context/api';
...
const DashboardScreen = () => {
  ...
  const getGraphData = () => {
    return [
      ...
      {
        label: 'On Hold',
        count: cardData[3].count,
        color: '#ffefd8'
      },
      {
        label: 'Rejected',
        count: cardData[4].count,
        color: '#ffe4e6'
      },
    ];
  };
