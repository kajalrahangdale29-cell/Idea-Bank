...
//               <Text style={styles.remarkLabel}>Remark * (Max 100 characters)</Text>
//               <TextInput
...
//                 maxLength={100}
//               />
//               <Text style={styles.characterCount}>{remarkText.length}/100</Text>
//             </View>
...
//   actionButtonsContainer: { flexDirection: 'row', backgroundColor: '#fff', paddingHorizontal: 12, paddingVertical: 12, borderTopWidth: 1, borderTopColor: '#e0e0e0', elevation: 8, shadowColor: '#000', shadowOffset: { width: 0, height: -2 }, shadowOpacity: 0.1, shadowRadius: 4, gap: 8 },
//   editButton: { flex: 1, backgroundColor: '#607D8B', paddingVertical: 10, borderRadius: 6, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 4, elevation: 2 },
//   approveButton: { flex: 1, backgroundColor: '#4CAF50', paddingVertical: 10, borderRadius: 6, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 4, elevation: 2 },
//   rejectButton: { flex: 1, backgroundColor: '#F44336', paddingVertical: 10, borderRadius: 6, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 4, elevation: 2 },
//   holdButton: { flex: 1, backgroundColor: '#FFC107', paddingVertical: 10, borderRadius: 6, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 4, elevation: 2 },
//   actionButtonText: { color: '#fff', fontSize: 11, fontWeight: 'bold', textTransform: 'uppercase' },
          ...
          <ScrollView contentContainerStyle={styles.modalScrollContent}>
            {selectedIdea && ideaDetail && (
              <>
                ...
                {/* Add spacing at bottom for buttons */}
...
const styles = StyleSheet.create({
  ...
  editButton: { flex: 1, backgroundColor: '#607D8B', paddingVertical: 11, borderRadius: 6, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 4, elevation: 2 },
  approveButton: { flex: 1, backgroundColor: '#4CAF50', paddingVertical: 11, borderRadius: 6, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 4, elevation: 2 },
  rejectButton: { flex: 1, backgroundColor: '#F44336', paddingVertical: 11, borderRadius: 6, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 4, elevation: 2 },
  holdButton: { flex: 1, backgroundColor: '#FFC107', paddingVertical: 11, borderRadius: 6, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 4, elevation: 2 },
  actionButtonText: { color: '#fff', fontSize: 10, fontWeight: 'bold', textTransform: 'uppercase' },
  remarkModalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center', alignItems: 'center', padding: 20 },
  remarkModalContainer: { backgroundColor: '#fff', borderRadius: 12, width: '100%', maxWidth: 500, overflow: 'hidden', elevation: 5 },
  remarkModalHeader: { backgroundColor: '#2c5aa0', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 20, paddingVertical: 16 },
  remarkModalTitle: { fontSize: 18, fontWeight: 'bold', color: '#fff', flex: 1 },
