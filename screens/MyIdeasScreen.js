...
//         name: afterImage.name || 'after_image.jpg',
//       });
...
//           <Text style={styles.infoValueFull}>{ideaDetail.ideaDescription || "N/A"}</Text>
//         </View>
//         <View style={styles.infoRowColumn}>
//           <Text style={styles.infoLabel}>Proposed Solution:</Text>
//           <Text style={styles.infoValueFull}>{ideaDetail.proposedSolution || "N/A"}</Text>
//         </View>
//         <View style={styles.infoRowColumn}>
//           <Text style={styles.infoLabel}>Process Improvement:</Text>
//           <Text style={styles.infoValueFull}>{ideaDetail.tentativeBenefit || "N/A"}</Text>
//         </View>
//         <View style={styles.infoRow}>
...
//           <Text style={styles.noFileText}>{afterImage ? afterImage.name : 'No file chosen'}</Text>
//         </TouchableOpacity>

//         {afterImage && (
//           <View style={styles.imagePreviewContainer}>
//             <View style={styles.imageNameRow}>
//               <Ionicons name="document-attach" size={20} color="#2c5aa0" />
//               <Text style={styles.imageName} numberOfLines={1}>{afterImage.name}</Text>
//               <TouchableOpacity onPress={() => setShowImagePreview(true)}>
//                 <Ionicons name="eye-outline" size={24} color="#2c5aa0" />
//               </TouchableOpacity>
//             </View>
//             {afterImage.uri && afterImage.mimeType?.startsWith('image/') && (
//               <Image 
...
//       {/* Progress Timeline Card with View Button */}
//       <View style={styles.infoCard}>
//         <View style={styles.timelineHeaderRow}>
//           <Text style={styles.infoCardHeading}>Progress Timeline</Text>
//           <TouchableOpacity 
//             style={styles.viewTimelineButton}
//             onPress={() => setShowTimelineModal(true)}
//           >
//             <Ionicons name="eye-outline" size={18} color="#fff" />
//             <Text style={styles.viewTimelineButtonText}>View Timeline</Text>
//           </TouchableOpacity>
//         </View>
//       </View>

//       {/* Submit Button - Before Remarks */}
//       <TouchableOpacity
...
//   return (
//     <ScrollView contentContainerStyle={styles.implementationFormContainer}>
//       {/* Progress Timeline Card - Top Position */}
//       <View style={styles.infoCard}>
//         <View style={styles.timelineHeaderRow}>
//           <Text style={styles.infoCardHeading}>Progress Timeline</Text>
//           <TouchableOpacity 
...
//           >
//             <Ionicons name="eye-outline" size={18} color="#fff" />
//             <Text style={styles.viewTimelineButtonText}>View</Text>
//           </TouchableOpacity>
//         </View>
//       </View>
