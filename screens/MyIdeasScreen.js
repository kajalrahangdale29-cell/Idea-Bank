...
//                               <Image source={{ uri: normalizeImagePath(ideaDetail.implementationCycle.beforeImplementationImagePath) }} style={styles.implementationImage} contentFit="cover" />
//                             </TouchableOpacity>
//                           </View>
//                         )}
...
//           <View style={styles.implementationImageSection}>
//             <Image source={{ uri: ideaDetail.beforeImplementationImagePath }} style={styles.implementationImage} contentFit="cover" />
//           </View>
//         </View>
//       )}
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.data?.success) {
        ...
        console.log('❌ Implementation submission failed:', response.data?.message);
        Alert.alert('Error', response.data?.message || 'Failed to submit implementation');
      }
    } catch (error) {
