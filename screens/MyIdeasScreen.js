  ...
  return (
    <View style={styles.timelineItem}>
      ...
      <View style={styles.timelineContent}>
        <Text style={styles.timelineStatus}>{typeof status === "string" ? status : "N/A"}</Text>
        {description && <Text style={styles.timelineDescription}>{typeof description === "string" ? description : ""}</Text>}
...
function RemarksCard({ title, comment, date }) {
  return (
    <View style={styles.remarkCard}>
      <Text style={styles.remarkTitle}>{typeof title === "string" ? title : "N/A"}</Text>
      <Text style={styles.remarkComment}>{typeof comment === "string" ? comment : "N/A"}</Text>
      <Text style={styles.remarkDate}>{typeof date === "string" ? date : ""}</Text>
    </View>
  );
}
            ...
            >
              <View style={styles.cardHeader}>
                <Text style={styles.ideaNumber} numberOfLines={2}>
                  {typeof idea.ideaNumber === "string" ? idea.ideaNumber : "N/A"}
                </Text>
                <View style={styles.typeTag}>
                  <Text style={styles.typeText}>
                    {typeof idea.ideaType === "string" ? idea.ideaType : "N/A"}
                  </Text>
                </View>
              </View>
              ...
              <View style={styles.cardContent}>
                <View style={styles.rowDetail}>
                  ...
                  <Text style={styles.value} numberOfLines={2}>
                    {typeof idea.ideaDescription === "string" ? idea.ideaDescription : "N/A"}
                  </Text>
                </View>
                ...
                <View style={styles.rowDetail}>
                  ...
                  <Text style={styles.value} numberOfLines={2}>
                    {typeof idea.proposedSolution === "string" ? idea.proposedSolution : "N/A"}
                  </Text>
                </View>
                ...
                <View style={styles.row}>
                  ...
                  <Text style={styles.value}>
                    {formatDate(idea.ideaCreationDate)}
                  </Text>
                </View>
                ...
                <View style={styles.rowDetail}>
                  ...
                  <View style={{ flex: 1, alignItems: "flex-end" }}>
                    <Text
                      style={[
                        styles.statusBadge,
                        { backgroundColor: getStatusColor(String(idea.ideaStatus)) }
                      ]}
                      numberOfLines={2}
                    >
                      {typeof idea.ideaStatus === "string" ? idea.ideaStatus : "N/A"}
                    </Text>
                  </View>
                </View>
              </View>
                ...
                {employeeInfoExpanded && (
                  <View style={styles.cardDetail}>
                    <View style={styles.rowDetailWithBorder}>
                      ...
                      <Text style={styles.valueDetail}>{typeof ideaDetail.ideaOwnerName === "string" ? ideaDetail.ideaOwnerName : "N/A"}</Text>
                    </View>
                    <View style={styles.rowDetailWithBorder}>
                      <Text style={styles.labelDetail}>Employee Number:</Text>
                      <Text style={styles.valueDetail}>{typeof ideaDetail.ideaOwnerEmployeeNo === "string" ? ideaDetail.ideaOwnerEmployeeNo : "N/A"}</Text>
                    </View>
                    <View style={styles.rowDetailWithBorder}>
                      <Text style={styles.labelDetail}>Employee Email:</Text>
                      <Text style={styles.valueDetail}>{typeof ideaDetail.ideaOwnerEmail === "string" ? ideaDetail.ideaOwnerEmail : "N/A"}</Text>
                    </View>
                    <View style={styles.rowDetailWithBorder}>
                      <Text style={styles.labelDetail}>Department:</Text>
                      <Text style={styles.valueDetail}>{typeof ideaDetail.ideaOwnerDepartment === "string" ? ideaDetail.ideaOwnerDepartment : "N/A"}</Text>
                    </View>
                    <View style={styles.rowDetailWithBorder}>
                      <Text style={styles.labelDetail}>Mobile:</Text>
                      <Text style={styles.valueDetail}>{typeof ideaDetail.mobileNumber === "string" ? ideaDetail.mobileNumber : "N/A"}</Text>
                    </View>
                    <View style={styles.rowDetailWithBorder}>
                      <Text style={styles.labelDetail}>Reporting Manager:</Text>
                      <Text style={styles.valueDetail}>{typeof ideaDetail.reportingManagerName === "string" ? ideaDetail.reportingManagerName : "N/A"}</Text>
                    </View>
                    <View style={styles.rowDetailWithBorder}>
                      <Text style={styles.labelDetail}>Manager Email:</Text>
                      <Text style={styles.valueDetail}>{typeof ideaDetail.managerEmail === "string" ? ideaDetail.managerEmail : "N/A"}</Text>
                    </View>
                    <View style={styles.rowDetailWithBorder}>
                      <Text style={styles.labelDetail}>Employee Location:</Text>
                      <Text style={styles.valueDetail}>{typeof ideaDetail.location === "string" ? ideaDetail.location : "N/A"}</Text>
                    </View>
                    <View style={styles.rowDetail}>
                      <Text style={styles.labelDetail}>Sub Department:</Text>
                      <Text style={styles.valueDetail}>{typeof ideaDetail.ideaOwnerSubDepartment === "string" ? ideaDetail.ideaOwnerSubDepartment : "N/A"}</Text>
                    </View>
                  </View>
                )}
                ...
                {ideaInfoExpanded && (
                  <View style={styles.cardDetail}>
                    <View style={styles.rowDetailWithBorder}>
                      ...
                      <Text style={styles.valueDetail}>{typeof ideaDetail.ideaNumber === "string" ? ideaDetail.ideaNumber : "N/A"}</Text>
                    </View>
                    <View style={styles.rowDetailWithBorder}>
                      <Text style={styles.labelDetail}>Solution Category:</Text>
                      <Text style={styles.valueDetail}>{typeof ideaDetail.solutionCategory === "string" ? ideaDetail.solutionCategory : "N/A"}</Text>
                    </View>
                    <View style={styles.rowDetailWithBorder}>
                    ...
                    <View style={styles.rowDetailWithBorder}>
                      ...
                      <Text
                        style={[
                          ...
                          { backgroundColor: getStatusColor(typeof ideaDetail.ideaStatus === "string" ? ideaDetail.ideaStatus : "") }
                        ]}
                      >
                        {typeof ideaDetail.ideaStatus === "string" ? ideaDetail.ideaStatus : "N/A"}
                      </Text>
                    </View>

                    <View style={styles.rowDetailVertical}>
                      <Text style={styles.labelDetailVertical}>Idea Description:</Text>
                      <Text style={styles.valueDetailVertical}>{typeof ideaDetail.ideaDescription === "string" ? ideaDetail.ideaDescription : "N/A"}</Text>
                    </View>

                    <View style={styles.rowDetailVertical}>
                      <Text style={styles.labelDetailVertical}>Proposed Solution:</Text>
                      <Text style={styles.valueDetailVertical}>{typeof ideaDetail.proposedSolution === "string" ? ideaDetail.proposedSolution : "N/A"}</Text>
                    </View>

                    <View style={styles.rowDetailVertical}>
                      <Text style={styles.labelDetailVertical}>Process Improvement/Cost Benefit:</Text>
                      <Text style={styles.valueDetailVertical}>{typeof ideaDetail.tentativeBenefit === "string" ? ideaDetail.tentativeBenefit : "N/A"}</Text>
                    </View>

                    <View style={styles.rowDetailWithBorder}>
                      <Text style={styles.labelDetail}>Team Members:</Text>
                      <Text style={styles.valueDetail}>{typeof ideaDetail.teamMembers === "string" ? ideaDetail.teamMembers : "N/A"}</Text>
                    </View>
                    <View style={styles.rowDetailWithBorder}>
                      <Text style={styles.labelDetail}>Idea Theme:</Text>
                      <Text style={styles.valueDetail}>{typeof ideaDetail.ideaTheme === "string" ? ideaDetail.ideaTheme : "N/A"}</Text>
                    </View>
                    <View style={styles.rowDetailWithBorder}>
                      <Text style={styles.labelDetail}>Type:</Text>
                      <Text style={styles.valueDetail}>
                        {typeof ideaDetail.ideaType === "string" ? ideaDetail.ideaType : (typeof ideaDetail.type === "string" ? ideaDetail.type : "N/A")}
                      </Text>
                    </View>
                    <View style={styles.rowDetailWithBorder}>
                      ...
                      <View style={styles.cardDetail}>
                        <View style={styles.rowDetailWithBorder}>
                          ...
                          <Text
                            style={[
                              styles.statusBadgeDetail,
                              { backgroundColor: getStatusColor(typeof ideaDetail.implementationCycle?.status === "string" ? ideaDetail.implementationCycle.status : "") }
                            ]}
                          >
                            {typeof ideaDetail.implementationCycle?.status === "string" ? ideaDetail.implementationCycle.status : "N/A"}
                          </Text>
                        </View>
                        ...
                        <View style={styles.rowDetailVertical}>
                          ...
                          <Text style={styles.valueDetailVertical}>
                            {typeof ideaDetail.implementationCycle?.implementation === "string" ? ideaDetail.implementationCycle.implementation :
                              (typeof ideaDetail.implementationDetail === "string" ? ideaDetail.implementationDetail :
                                (typeof ideaDetail.implementation === "string" ? ideaDetail.implementation : "Not provided"))}
                          </Text>
                        </View>
                        ...
                        <View style={styles.rowDetailVertical}>
                          ...
                          <Text style={styles.valueDetailVertical}>
                            {typeof ideaDetail.implementationCycle?.outcome === "string" ? ideaDetail.implementationCycle.outcome :
                              (typeof ideaDetail.implementationOutcome === "string" ? ideaDetail.implementationOutcome :
                                (typeof ideaDetail.outcome === "string" ? ideaDetail.outcome : "Not provided"))}
                          </Text>
                        </View>
