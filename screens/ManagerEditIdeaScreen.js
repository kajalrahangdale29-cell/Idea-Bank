...
//   if (cleanPath.startsWith('https://ideabank-dev.abisaio.com')) {
//     return cleanPath.replace(
//       'https://ideabank-dev.abisaio.com',
//       API_BASE_URL
//     );
//   }
...
// //   const [fileName, setFileName] = useState(() => {
// //     if (typeof safeExistingFile !== 'string') return '';

// //     if (safeExistingFile.toLowerCase().includes('.pdf')) {
// //       return 'Existing PDF Document';
// //     }

// //     try {
// //       const parts = safeExistingFile.split('/');
// //       const lastPart = parts.length ? parts[parts.length - 1] : '';
// //       return decodeURIComponent(lastPart) || 'Existing Image';
// //     } catch {
// //       return 'Existing Image';
...
// //     return safeExistingFile.toLowerCase().includes('.pdf') ? 'pdf' : 'image';
// //   });
