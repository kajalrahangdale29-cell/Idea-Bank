...
export default function MyTeamIdeasScreen() {
  ...
  const handleApprove = () => {
    Alert.alert("Approve Idea", "Are you sure you want to approve this idea?", [
      { text: "Cancel", style: "cancel" },
      { text: "Approve", onPress: () => Alert.alert("Success", "Idea approved successfully!") }
    ]);
  };

  const handleReject = () => {
    Alert.alert("Reject Idea", "Are you sure you want to reject this idea?", [
      { text: "Cancel", style: "cancel" },
      { text: "Reject", style: "destructive", onPress: () => Alert.alert("Success", "Idea rejected successfully!") }
    ]);
  };

  const handleHold = () => {
    Alert.alert("Hold Idea", "Are you sure you want to put this idea on hold?", [
      { text: "Cancel", style: "cancel" },
      { text: "Hold", onPress: () => Alert.alert("Success", "Idea put on hold successfully!") }
    ]);
  };
    ...
    <View style={styles.container}>
      ...
      <Modal visible={!!selectedIdea} animationType="slide">
        <View style={styles.fullModal}>
          ...
          <View style={styles.actionButtonsContainer}>
            <TouchableOpacity style={styles.approveButton} onPress={handleApprove}><Text style={styles.actionButtonText}>Approve</Text></TouchableOpacity>
            <TouchableOpacity style={styles.rejectButton} onPress={handleReject}><Text style={styles.actionButtonText}>Reject</Text></TouchableOpacity>
            <TouchableOpacity style={styles.holdButton} onPress={handleHold}><Text style={styles.actionButtonText}>Hold</Text></TouchableOpacity>
          </View>
        </View>
      </Modal>
