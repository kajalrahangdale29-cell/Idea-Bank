...
//     if (existingFile.includes('.pdf')) return 'Existing PDF';
//     const urlParts = existingFile.split('/');
//     return urlParts[urlParts.length - 1] || 'Existing Image';
//   });
...
//       if (file) {
//         const isNewFile = file.startsWith('file://') || file.startsWith('content://');
...
//         ]);
//       } else {
//         Alert.alert('Error', data?.message || `Failed to update idea. Status: ${response.status}`);
//       }
