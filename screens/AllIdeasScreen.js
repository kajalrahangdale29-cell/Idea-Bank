...
//   const fetchIdeas = async (from = null, to = null, status = "") => {
//     setLoading(true);
//     try {
//       const token = await AsyncStorage.getItem("token");
//       const authHeaders = token ? { Authorization: `Bearer ${token}` } : {};
...
//       ) {
//         setIdeas(response.data.data.items);
//         setTotalItems(response.data.data.total || response.data.data.items.length);
//       } else {
//         setIdeas([]);
//         setTotalItems(0);
//       }
...
//     fetchIdeas(from, to, selectedStatus);
...
//                 style={[
//                   styles.statusChip,
//                   selectedStatus === (status === "All Status" ? "" : status) && styles.statusChipActive
//                 ]}
//                 onPress={() => setSelectedStatus(status === "All Status" ? "" : status)}
//               >
//                 <Text style={[
//                   styles.statusChipText,
//                   selectedStatus === (status === "All Status" ? "" : status) && styles.statusChipTextActive
//                 ]}>
//                   {status}
//                 </Text>
//               </TouchableOpacity>
...
//                         <Text style={styles.label}>Created:</Text>
//                         <Text style={styles.dateText}>
//                           {idea.creationDate ? formatDate(idea.creationDate) : "N/A"}
//                         </Text>
//                       </View>
//                     </View>
//                     <View style={styles.statusRow}>
//                       <Text style={styles.label}>Status:</Text>
//                       <Text style={[styles.statusBadge, { backgroundColor: getStatusColor(idea.status) }]} numberOfLines={1}>
//                         {idea.status || "N/A"}
//                       </Text>
//                     </View>
//                   </View> */}
...
const styles = StyleSheet.create({
  ...
  paginationContainer: { flexDirection: "row", justifyContent: "center", marginVertical: 15, flexWrap: "wrap", paddingBottom: 10 },
